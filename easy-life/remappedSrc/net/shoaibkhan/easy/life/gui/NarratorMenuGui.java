...
public class NarratorMenuGui extends LightweightGuiDescription {
    ...
    public NarratorMenuGui(ClientPlayerEntity player, MinecraftClient client) {
        ...
        NarratorMenuButton wb11 = new NarratorMenuButton(Text.of("Target Block Type"));
        wb11.setOnClick(this::target_block_type);
        root.add(wb11, 8, 0, 7, 1);

        NarratorMenuButton wb12 = new NarratorMenuButton(Text.of("Target Block Postion"));
        wb12.setOnClick(this::target_block_position);
        root.add(wb12, 8, 4, 7, 1);


        NarratorMenuButton wb21 = new NarratorMenuButton(Text.of("Chunk Position"));
        wb21.setOnClick(this::chunk_position);
        root.add(wb21, 0, 2, 7, 1);

        NarratorMenuButton wb22 = new NarratorMenuButton(Text.of("Light Level"));
        wb22.setOnClick(this::light_level);
        root.add(wb22, 8, 2, 7, 1);

        NarratorMenuButton wb23 = new NarratorMenuButton(Text.of("Target Entity"));
    ...
    private void target_block_type() {
        ...
        switch (hit.getType()) {
            case MISS:
                this.player.sendMessage(Text.of("Target is too far"), true);
                break;
            case BLOCK:
                ...
                this.player.sendMessage(Text.of("" + name), true);
                break;
            default:
                break;
        }
    ...
    private void target_block_position() {
        ...
        switch (hit.getType()) {
            ...
            case BLOCK:
                ...
                this.player.sendMessage(Text.of("Block Position is, " + posX + "x, " + posY + "y, " + posZ + "z"), true);
                break;
            default:
                break;
        }
    ...
    private void chunk_position() {
        ...
        if (posY.contains("-")) posY = posY.replace("-", "negative");
        if (posZ.contains("-")) posZ = posZ.replace("-", "negative");
        this.player.sendMessage(Text.of("Chunk Position is, " + posX + "x, " + posY + "y, " + posZ + "z"), true);
    }

    private void light_level() {
        this.player.closeScreen();
        int light = this.client.world.getLightLevel(this.player.getBlockPos());
        this.player.sendMessage(Text.of("Light level is, " + light), true);
    }
        ...
        switch (hit.getType()) {
            ...
            case ENTITY:
                try {
                    ...
                    this.player.sendMessage(Text.of("No Entity Present"), true);
                    break;
                }
