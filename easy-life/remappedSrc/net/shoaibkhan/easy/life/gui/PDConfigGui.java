...
public class PDConfigGui extends LightweightGuiDescription {
    ...
    public PDConfigGui(ClientPlayerEntity player, MinecraftClient client) {
        ...
        WLabel label = new WLabel(Text.of("Player Direction Configuration"), ClientMod.colors("red", 100));
        ...
        WLabel pd_color_label = new WLabel(Text.of("Text Color :-"), ClientMod.colors("black", 100));
        ...
        WTextField pdcolortf = new WTextField(Text.of("" + ELConfig.getString(ELConfig.getPdColorCustomVal())));
        ...
        WTextField pd_color_opacity_field = new WTextField(Text.of(ELConfig.getString(ELConfig.getPdColorOpacity())));
        ...
        WLabel pd_background_color_label = new WLabel(Text.of("Background Color :-"), ClientMod.colors("black", 100));
        ...
        WTextField pd_bg_color_opacity_field = new WTextField(Text.of(ELConfig.getString(ELConfig.getPdBgColorOpacity())));
        ...
        WLabel pdpos = new WLabel(Text.of("Position :-"), ClientMod.colors("black", 100));
        ...
        WTextField pdxf = new WTextField(Text.of(ELConfig.getString(ELConfig.getPdPositionX())));
        ...
        WTextField pdyf = new WTextField(Text.of(ELConfig.getString(ELConfig.getPdPositionY())));
