...
public class PCConfigGui extends LightweightGuiDescription {
    ...
    public PCConfigGui(ClientPlayerEntity player, MinecraftClient client) {
        ...
        WLabel label = new WLabel(Text.of("Player Coordination Configuration"), ClientMod.colors("red", 100));
        ...
        WLabel pc_color_label = new WLabel(Text.of("Text Color :-"), ClientMod.colors("black", 100));
        ...
        WTextField pccolortf = new WTextField(Text.of("" + ELConfig.getString(ELConfig.getPcColorCustomVal())));
        ...
        WTextField pc_color_opacity_field = new WTextField(Text.of(ELConfig.getString(ELConfig.getPcColorOpacity())));
        ...
        WLabel pc_background_color_label = new WLabel(Text.of("Background Color :-"), ClientMod.colors("black", 100));
        ...
        WTextField pc_bg_color_opacity_field = new WTextField(Text.of(ELConfig.getString(ELConfig.getPcBgColorOpacity())));
        ...
        WLabel pcpos = new WLabel(Text.of("Position :-"), ClientMod.colors("black", 100));
        ...
        WTextField pcxf = new WTextField(Text.of(ELConfig.getString(ELConfig.getPcPositionX())));
        ...
        WTextField pcyf = new WTextField(Text.of(ELConfig.getString(ELConfig.getPcPositionY())));
