...
public class ELConfig {
    ...
    public static final String Player_Coordinates_Key = "player_coordinates",PC_Color = "pc_color",PC_Color_Custom = "pc_color_custom",PC_Color_Custom_val = "pc_color_custom_val",PC_Bg_Color_Custom_val = "pc_bg_color_custom_val",PC_Bg_Color_Custom = "pc_bg_color_custom", PC_Bg_Color = "pc_bg_color",PC_Position_X = "pc_position_x",PC_Position_Y = "pc_position_y";
    ...
    private static JsonObject resetData(){
        ...
        data.add(PC_Color_Custom_val,new JsonPrimitive("100"));
        data.add(PC_Bg_Color, new JsonPrimitive("black"));
        data.add(PC_Bg_Color_Custom, new JsonPrimitive(false));
        data.add(PC_Bg_Color_Custom_val,new JsonPrimitive("100"));
    ...
    public static String getPcBgColorCustom() {
        return PC_Bg_Color_Custom;
    }
    ...
    public static String getPcBgColorCustomVal() {
        return PC_Bg_Color_Custom_val;
    }
}