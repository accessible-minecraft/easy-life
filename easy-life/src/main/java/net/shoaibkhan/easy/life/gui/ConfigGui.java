...
public class ConfigGui extends LightweightGuiDescription {
    ...
    public ConfigGui(ClientPlayerEntity player, MinecraftClient client) {
        ...
        WButton playerWarningsSettings = new WButton(Text.of(I18n.translate("gui.easylife.playerWarningsSettings")));
        ...
        WButton playerCoordinatesOverlaySettings = new WButton(Text.of(I18n.translate("gui.easylife.playerCoordinatesOverlaySettings")));
        playerCoordinatesOverlaySettings.setOnClick(this::pcClick);
        root.add(playerCoordinatesOverlaySettings, 1, 11, 11, 1);

        WButton playerDirectionOverlaySettings = new WButton(Text.of(I18n.translate("gui.easylife.playerDirectionOverlaySettings")));
